...
const PillNav = ({
  ...
  className = '',
  ease = 'power3.easeOut',
  baseColor = 'rgba(5, 12, 18, 0.76)',
  pillColor = 'rgba(12, 22, 30, 0.86)',
  ...
  return (
    <div className="pill-nav-container">
      <nav className={`pill-nav ${className}`} aria-label="Primary" style={cssVars}>
        <a
          className="pill-home-logo"
          href="#top"
          aria-label="Back to homepage"
          onPointerDownCapture={returnToHome}
        >
          <span className="pill-home-fallback" aria-hidden="true" />
        </a>
